...
func (r Running) Calories() float64 {
	...
	return ((CaloriesMeanSpeedMultiplier*r.meanSpeed() + CaloriesMeanSpeedShift) * r.Weight / MInKm) * durationInHours * MinInHours
}
...
func (w Walking) Calories() float64 {
	...
	return ((CaloriesWeightMultiplier*w.Weight + (math.Pow(speedInMsec, 2) / (w.Height / CmInM))) * CaloriesSpeedHeightMultiplier * w.Weight) * durationInHours * MinInHours
...
func (s Swimming) meanSpeed() float64 {
	...
	return (s.LengthPool * float64(s.CountPool)) / MInKm / durationInHours
}
